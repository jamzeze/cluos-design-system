...
/**
 * Resolve the final role set for a style + optional palette id.
 * Mirrors the CSS cascade in tokens.css exactly (palette overrides
...
module.exports = { tokens, default: tokens, styles, palettes, palettesDark, resolveTheme };
